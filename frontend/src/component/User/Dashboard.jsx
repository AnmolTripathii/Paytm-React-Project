...
const Dashboard = () => {
    ...
    return (
        <div className='lg:h-[93.3vh] overflow-y-auto custom-scrollbar '>
            <div className="bg-slate-800 flex flex-col items-center justify-start custom-scrollbar overflow-y-auto  lg:h-[93.3vh] p-4">
