...
import { FaHome, FaMoneyBill, FaUser, FaExchangeAlt, FaUsers, FaTimes, FaRegListAlt, FaSignOutAlt, FaBars, FaRobot } from 'react-icons/fa';
    ...
    return (
        <div className="flex">
            <div className="hidden lg:flex flex-col bg-gray-900 text-white w-96 p-6 h-screen">
                ...
                <div className="flex flex-col flex-1 space-y-8">
                    ...
                    <button
                        ...
                        className="flex items-center text-2xl font-bold p-4 rounded-lg hover:bg-gray-700 hover:text-green-300 transition-colors"
                    >
                        <FaRobot />
            ...
            <div className="lg:hidden flex flex-col bg-gray-900 text-white p-6 relative">
                ...
                <div
                    className={`absolute top-0 left-0 w-64 bg-gray-900 p-4 transform transition-transform duration-300 ease-in-out z-50 ${isOpen ? 'translate-x-0' : '-translate-x-full'
                        }`}
                >
                    ...
                    <div className="flex flex-col space-y-6 mt-6">
                        ...
                        <button
                            ...
                            className="flex items-center text-xl hover:text-green-300 transition-colors"
                        >
                            <FaRobot />
