        ...
        <div className=" flex w-full justify-evenly items-center gap-4 px-4 py-2 bg-white shadow-md rounded-lg">
            <div className="relative w-full">
                ...
                {appearedUser.length > 0 && (
                    <div className={`absolute top-full ${appearedUser.length >= 9 ? 'h-[60vh]' : 'h-auto'} overflow-y-scroll custom-scrollbar left-0 w-full bg-gray-900 text-white shadow-lg rounded-lg mt-2 z-10 max-w-md sm:max-w-full md:max-w-xl`}>
